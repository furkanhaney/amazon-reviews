...
from manta.trainer import ModelTrainer


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--lr", help="Learning rate for the adam optimizer.", type=float, default=10e-4)
    parser.add_argument("-g", "--gpu", help="Trains the model on gpu.", action='store_true')
